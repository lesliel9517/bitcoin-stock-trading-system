...
class ProfessionalDashboard:
    ...
    def render_combined_chart(self) -> Panel:
        ...
        # Build chart string with price labels (2 decimal places)
        lines = []
        for row_idx, row in enumerate(chart):
            # Add price labels with 2 decimal places
            if row_idx == 0:
                label = f"${max_p:>8.2f} │"
    ...
    def update_stats(self, equity: float, position: str, market_regime: str = "", volatility: str = ""):
        """Update statistics"""
